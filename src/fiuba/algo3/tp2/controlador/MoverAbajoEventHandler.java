...
public class MoverAbajoEventHandler implements EventHandler<ActionEvent> {
    private JuegoView juegoView;
    private Unidad pieza;
    private Mapa mapa;

    public MoverAbajoEventHandler(JuegoView juegoView, Juego juego, Unidad unidad) {
        mapa = juego.mapa();
        this.pieza = unidad;
    ...
    public void handle(ActionEvent event) {
        ...
        try {
            mapa.moverUnidad(pieza.obtenerPosicion(), new DireccionAbajo());
        }
