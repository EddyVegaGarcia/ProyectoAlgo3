...
import fiuba.algo3.tp2.modelo.Exception.DesmontarIncogruenciaException;
...
public class DesmontarEventHandler implements EventHandler<ActionEvent> {
    ...
    public DesmontarEventHandler(JuegoView unJuegoView, Juego unJuego, Canvas unCanvasCentral, Montable unaPiezaMontable, PiezaType unaPiezaType, Label etiquetaConsola) {
    ...
    public void handle(ActionEvent actionEvent) {
        ...
        try {
            piezaMontable.desmontar();
        }
        catch (DesmontarIncogruenciaException e){
            etiquetaAlertas.setText("La pieza montable ya está desmontada");
        }
